...
describe("pipeline integration — cliente → propriedade → orçamento → serviço → despesa", () => {
  ...
  const matches: HybridMatch[] = [
    { header: "Cliente", field: byId("cliente.nome"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "CPF", field: byId("cliente.cpf"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Propriedade", field: byId("propriedade.nome"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Matrícula", field: byId("propriedade.matricula"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Área (ha)", field: byId("propriedade.area"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Código Orçamento", field: byId("orcamento.codigo"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Valor Orçado", field: byId("orcamento.valor_orcado"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Status Orçamento", field: byId("orcamento.status"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Forma Pagamento", field: byId("orcamento.forma_pagamento"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Situação Pagamento", field: byId("orcamento.situacao_pagamento"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Data Emissão", field: byId("orcamento.data_emissao"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Serviço", field: byId("servico.nome"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Status Serviço", field: byId("servico.status"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Data Início Serviço", field: byId("servico.data_inicio"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
    { header: "Despesas", field: byId("financeiro.despesas"), score: 1, headerScore: 1, contentScore: 1, isCustomField: false, reason: "" },
  ];
