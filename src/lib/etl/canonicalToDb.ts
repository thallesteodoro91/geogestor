...
export const CANONICAL_TO_COLUMN: Record<string, { table: string; column: string }> = {
  ...
  "propriedade.tipo":        { table: "dim_propriedade", column: "tipo_propriedade" },
  ...
  "propriedade.area":        { table: "dim_propriedade", column: "area" },
  ...
  "servico.responsavel":     { table: "fato_servico", column: "responsavel" },
  ...
  "orcamento.desconto":           { table: "fato_orcamento", column: "valor_desconto" },
  ...
  "orcamento.status":             { table: "fato_orcamento", column: "status_do_orcamento" },
  ...
  // FINANCEIRO (mapeia para fato_orcamento por padrão; despesas usam outra rotina)
  ...
  "financeiro.receita_realizada":  { table: "fato_orcamento", column: "receita_esperada" },
