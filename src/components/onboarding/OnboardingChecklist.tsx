...
import { CheckCircle2, Circle, Rocket, X, ChevronDown, ChevronUp } from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Passo {completedCount + 1} de {totalSteps} — Complete para começar
              </p>
            </div>
          </div>
          ...
          {steps.map((step, idx) => {
            ...
            return (
              ...
              >
                ...
                {isNext && (
                  <span className="text-xs font-medium text-primary shrink-0">Começar →</span>
                )}
              </button>
            );
          })}
